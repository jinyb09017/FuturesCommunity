...
public class BaseAction implements SessionAware,ServletRequestAware,CookiesAware,ServletResponseAware,ServletContextAware{
  protected Map<String,Object> session;
  protected Map<String,String> cookies;
  //protected Map<String,Object> request;,RequestAware
  protected static HttpServletRequest httpRequest;
  protected static HttpServletResponse httpResponse;
